...
void lcd1602_initial(){
    ...
    _displayfunction = 0x10 | 0x08 | 0x04;
    lcd1602_cmd(0x20 | _displayfunction);
    ...
    _displaymode = 0x02 | 0x01;
    lcd1602_cmd(0x04 | _displaymode);
...
void lcd1602_noDisplay(){
    ...
    lcd1602_cmd(0x08 | _displaycontrol);
}
...
void lcd1602_setCursor(unsigned char row, unsigned char col){
    ...
    lcd1602_cmd(0x80 | (col + row_offsets[row]));
}
...
void lcd1602_scrollDisplayLeft(){
    lcd1602_cmd(0x10 | 0x08 | 0x00);
}

void lcd1602_scrollDisplayRight(){
    lcd1602_cmd(0x10 | 0x08 | 0x04);
}
