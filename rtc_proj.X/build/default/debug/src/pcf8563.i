...
void PCF8563_setDate(unsigned short year, unsigned char mon, unsigned char day){
    year = ( ( ((year % 100)/10) << 4) + ((year % 100)%10) );
    mon = ( ( ((mon)/10) << 4) + ((mon)%10) ) | ((year > 1999) ? 0x80 : 0x00);
    day = ( ( ((day)/10) << 4) + ((day)%10) );
...
void PCF8563_getDate(unsigned int *year, unsigned int *mon, unsigned int *day){
    ...
    *year = (century == 1) ? (1900 + ( ( ((buf[0])>>4) *10) + ((buf[0]%16)) )) : (2000 + ( ( ((buf[0])>>4) *10) + ((buf[0]%16)) ));
    *mon = ( ( ((buf[1])>>4) *10) + ((buf[1]%16)) );
    *day = ( ( ((buf[2])>>4) *10) + ((buf[2]%16)) );


}

void PCF8563_setTime(unsigned char hour, unsigned char min, unsigned char sec){
    setI2C(0x04, ( ( ((hour)/10) << 4) + ((hour)%10) ));
    setI2C(0x03, ( ( ((min)/10) << 4) + ((min)%10) ));
    setI2C(0x02, ( ( ((sec)/10) << 4) + ((sec)%10) ));
}

void PCF8563_getTime(unsigned int *hour, unsigned int *min, unsigned int *sec){


    *hour = ( ( ((getI2C(0x04) & 0x3f)>>4) *10) + ((getI2C(0x04) & 0x3f%16)) );
    *min = ( ( ((getI2C(0x03) & 0x7f)>>4) *10) + ((getI2C(0x03) & 0x7f%16)) );
    *sec = ( ( ((getI2C(0x02) & 0x7f)>>4) *10) + ((getI2C(0x02) & 0x7f%16)) );
