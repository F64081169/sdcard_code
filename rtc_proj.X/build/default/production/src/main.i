...
# 1 "src/configuration_bits.h" 1
# 12 "src/configuration_bits.h"
...
void myISR(){
    ...
    while(PORTBbits.RB0 == 1){
        ...
        lcd1602_blink();
            if(PORTBbits.RB1 == 0 && year <= 2022){
                year++;
                printDate();
            }else if(PORTBbits.RB2 == 0 && year >= 2022){
                year--;
                printDate();
            }
    }
    ...
    while(PORTBbits.RB0 == 1){
        ...
        lcd1602_blink();
            if(PORTBbits.RB1 == 0 && month <= 11){
                month++;
                printDate();
            }else if(PORTBbits.RB2 == 0 && month >= 2){
                month--;
                printDate();
            }
    }
    ...
    while(PORTBbits.RB0 == 1){
        ...
        lcd1602_blink();
            if(PORTBbits.RB1 == 0 && day <= month_day[month] - 1){
                day++;
                printDate();
            }else if(PORTBbits.RB2 == 0 && day >= 2){
                day--;
                printDate();
            }
    }
    ...
    while(PORTBbits.RB0 == 1){
        ...
        lcd1602_blink();
            if(PORTBbits.RB1 == 0 && hour <= 22){
                hour++;
                printTime();
            }else if(PORTBbits.RB2 == 0 && hour >= 1){
                hour--;
                printTime();
            }
    }
    ...
    while(PORTBbits.RB0 == 1){
        ...
        lcd1602_blink();
            if(PORTBbits.RB1 == 0 && minute <= 59){
                minute++;
                printTime();
            }else if(PORTBbits.RB2 == 0 && minute >= 1){
                minute--;
                printTime();
            }
    }
    ...
    while(PORTBbits.RB0 == 1){
        ...
        lcd1602_blink();
            if(PORTBbits.RB1 == 0 && second <= 59){
                second++;
                printTime();
            }else if(PORTBbits.RB2 == 0 && second >= 1){
                second--;
                printTime();
            }
    }
